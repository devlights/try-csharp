...
namespace TryCSharp.Samples.Reflection.Emit
{
    ...
    public class EmitSample03 : IExecutable
    {
        ...
        public void Execute()
        {
            ...
            var asmBuilder = appDomain.DefineDynamicAssembly(asmName, AssemblyBuilderAccess.RunAndSave);
            var modBuilder = asmBuilder.DefineDynamicModule(ASM_NAME, MOD_NAME);
